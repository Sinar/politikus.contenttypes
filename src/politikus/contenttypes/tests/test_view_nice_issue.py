...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_nice_issue_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='nice-issue'
        )
        self.assertTrue(view.__name__ == 'nice-issue')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in nice-issue'
        # )

    def test_nice_issue_not_matching_interface(self):
