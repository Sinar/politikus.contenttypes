...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_nice_issue_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='nice-issue-view'
        )
        self.assertTrue(view.__name__ == 'nice-issue-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in nice-issue-view'
        # )

    def test_nice_issue_view_not_matching_interface(self):
